...
class ChunkStatusBreakdownTest {
    ...
    void constructor_shouldSetAllFields() {
        ChunkStatusBreakdown bd = new ChunkStatusBreakdown(1, 2, 3, 4, 5, 6, 7);
    ...
    void equals_sameValues_shouldBeEqual() {
        ChunkStatusBreakdown a = new ChunkStatusBreakdown(1, 2, 3, 4, 5, 6, 7);
        ChunkStatusBreakdown b = new ChunkStatusBreakdown(1, 2, 3, 4, 5, 6, 7);
        assertEquals(a, b);
    ...
    void equals_differentValues_shouldNotBeEqual() {
        ChunkStatusBreakdown a = new ChunkStatusBreakdown(1, 2, 3, 4, 5, 6, 7);
        ChunkStatusBreakdown b = new ChunkStatusBreakdown(1, 2, 3, 4, 5, 6, 8);
        assertNotEquals(a, b);
    }
    ...
    class Total {
        ...
        void allZeros_shouldReturnZero() {
            ChunkStatusBreakdown bd = new ChunkStatusBreakdown(0, 0, 0, 0, 0, 0, 0);
        ...
        void partialZeros_shouldSumCorrectly() {
            ChunkStatusBreakdown bd = new ChunkStatusBreakdown(0, 10, 0, 20, 0, 5, 0);
        ...
        void singleField_shouldReturnThatValue() {
            assertEquals(100, new ChunkStatusBreakdown(100, 0, 0, 0, 0, 0, 0).total());
            assertEquals(200, new ChunkStatusBreakdown(0, 200, 0, 0, 0, 0, 0).total());
            assertEquals(300, new ChunkStatusBreakdown(0, 0, 300, 0, 0, 0, 0).total());
            assertEquals(400, new ChunkStatusBreakdown(0, 0, 0, 400, 0, 0, 0).total());
            assertEquals(500, new ChunkStatusBreakdown(0, 0, 0, 0, 500, 0, 0).total());
            assertEquals(600, new ChunkStatusBreakdown(0, 0, 0, 0, 0, 600, 0).total());
            assertEquals(700, new ChunkStatusBreakdown(0, 0, 0, 0, 0, 0, 700).total());
        }
